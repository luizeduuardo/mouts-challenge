...
public class RemoveSaleItemHandlerTests
{
    ...
    public RemoveSaleItemHandlerTests()
    {
        ...
        _handler = new RemoveSaleItemHandler(_saleRepository, _mapper, _mediator);
    }
    ...
    [Fact(DisplayName = "Given an existing item When removing it Then publishes SaleModifiedEvent")]
